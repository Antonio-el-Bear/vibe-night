// This file provides appParams for the app. Copied from the other project for compatibility.
...
const getAppParamValue = (paramName, { defaultValue = undefined, removeFromUrl = false } = {}) => {
	...
	const storageKey = `placeholder_${toSnakeCase(paramName)}`;
...
const getAppParams = () => {
	if (getAppParamValue("clear_access_token") === 'true') {
		storage.removeItem('placeholder_access_token');
